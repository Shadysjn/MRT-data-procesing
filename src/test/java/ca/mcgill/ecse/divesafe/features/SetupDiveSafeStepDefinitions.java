...
public class SetupDiveSafeStepDefinitions {
  ...
  @When("the admin attempts to setup the NMC program information with the start date {string}, number of diving days {string}, and price of guide per day {string} \\(p10)")
  public void the_admin_attempts_to_setup_the_nmc_program_information_with_the_start_date_number_of_diving_days_and_price_of_guide_per_day_p10(
      String string, String string2, String string3) {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
  }

  @Then("the NMC program information shall be successfully setup with the start date {string}, number of diving days {string}, and price of guide per day {string} \\(p10)")
  ...
  @When("the admin attempts to setup the NMC program inforamtion with the start date {string}, number of diving days {string}, and price of guide per day {string} \\(p10)")
