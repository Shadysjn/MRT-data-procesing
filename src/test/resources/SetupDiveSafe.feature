Feature: Setup DiveSafe program information (p10)
  ...
  Scenario Outline: Setup NMC program information successfully
    When the admin attempts to setup the NMC program information with the start date "2022-01-13", number of diving days "20", and price of guide per day "50" (p10)
    Then the NMC program information shall be successfully setup with the start date "2022-01-13", number of diving days "20", and price of guide per day "50" (p10)

  Scenario Outline: Setup NMC program information with invalid inputs
    When the admin attempts to setup the NMC program inforamtion with the start date "<startDate>", number of diving days "<numDays>", and price of guide per day "<priceOfGuidePerDay>" (p10)
